...
public class AdminServlet extends BaseServlet {
    ...
    private void validPassword(HttpServletRequest request,HttpServletResponse response) throws IOException{
    	...
    	Admin admin = adminService.getByUserName(username);
    	response.getWriter().println(admin!=null&&password.equals(admin.getApwd()));
    }
    private void add(HttpServletRequest request,HttpServletResponse response) throws IOException{
    	String name = request.getParameter("name");
    	String password= request.getParameter("password");
    	String power= request.getParameter("power");
    	Admin admin = new Admin(name,password,Integer.parseInt(power));
    ...
    private void update(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException{
    	...
    	String password= request.getParameter("password");
    	String power= request.getParameter("power");
    	Admin admin = new Admin(Integer.parseInt(id), name, password,Integer.parseInt(power));
