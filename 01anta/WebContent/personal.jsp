...
<body>
    ...
    <div class="nav">
        <div class="nav-top">
            ...
            <div class="log-box">
                ...
                <c:if test="${user!=null }">
                	<div style="font-size: 12px;color: #000000;font-family: "Microsoft YaHei";">${user.uname },您好&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="tuichu">退出登录</a></div>
                </c:if>
            </div>
	...
	<!-- 主体 -->
	<div id="main">
		<frameset rows="100,*,50" frameborder="0" border="0" framespacing="0">
		
		</frameset>
		<div id="my">我的资料</div>
		<hr>
		<div id="ziliao">完善您的个人信息，有助于我们为您提供更加个性化的服务,安踏将尊重并保护您的隐私</div>
		<hr>
		<form style="text-align: center;" action="${pageContext.request.contextPath }/AdminUserServlet?m=updatePerson" method="POST" role="form"> 
        	<div class="form-group" style="text-align: center;">
	            <input type="hidden" name="id" value="${user.uid }">
	            
	            <label for="">真实姓名</label> 
				<input style="width: 40%; margin-left: auto; margin-right: auto;"
					type="text" class="form-control" id="name" value="${user.uname }" name="name" placeholder="真实姓名">
	            
	            <label for="">手机号</label>
				<input style="width: 40%; margin-left: auto; margin-right: auto;" type="text"
					class="form-control" id="phone" value="${user.utel }" name="phone" placeholder="手机号">
				...
				<label for="">邮箱</label>
				<input style="width: 40%; margin-left: auto; margin-right: auto;" type="text"
					class="form-control" id="email" value="${user.uemail }" name="email" placeholder="邮箱"> 
