...
<frameset   rows="100,*,50" frameborder="0" border="0" framespacing="0">
	...
	<frame src="${pageContext.request.contextPath}/admin/top.jsp" name="topFrame" scrolling="NO" noresize no-repeat> 
	...
	<frame src="${pageContext.request.contextPath}/admin/bottom.jsp" name="topFrame" scrolling="NO" noresize no-repeat> 
</frameset>
</html>