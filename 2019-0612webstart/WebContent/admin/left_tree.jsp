...
        d.add(0104,01,'用户管理');  
        d.add(010401,0104,'用户管理','${pageContext.request.contextPath}/UserServlet?m=list','','mainFrame');  

        d.add(0105,01,'商品管理');  
        d.add(010501,0105,'商品管理','${pageContext.request.contextPath}/ProductServlet?m=list','','mainFrame');  
        d.add(0106,01,'订单管理');  
        d.add(010601,0106,'订单管理','${pageContext.request.contextPath}/080101.jsp','','mainFrame');  
