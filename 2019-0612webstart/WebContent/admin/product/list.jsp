		...
		<tbody>
			<c:forEach items="${list}" var="d">
				<tr>
					...
					<td>${d.stock}</td>
					<td>${d.name}</td>
					<td><a href="ProductServlet?m=getById&id=${d.pid}">修改</a></td>
					<td><a href="#" onclick="del(${d.pid})">删除</a></td>
				</tr>
			</c:forEach>
			<tr>
			...
			<tr>
				<td colspan="12" align="center"><a href=${pageContext.request.contextPath }/ProductServlet?m=toAdd>添加</a></td>
			</tr>
		</tbody>
	</table>
</body>
