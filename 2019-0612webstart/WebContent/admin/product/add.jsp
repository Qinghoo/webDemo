...
<body>
<form style="text-align: center;" action="${pageContext.request.contextPath }/ProductServlet?m=add" method="POST" role="form" enctype="multipart/form-data"> 
   
        <div class="form-group" style="text-align: center;">
            <label for="">商品名称</label>
            <input style="width: 20%;margin-left: auto;margin-right: auto;" type="text" class="form-control" id="pname" name="pname" placeholder="填入管理员用户名">
            <label for="">商品价格</label>
            <input style="width: 20%;margin-left: auto;margin-right: auto;" type="text" class="form-control" id="price" name="price" placeholder="填入价格">
           ...
           <textarea id="editor_id" name="maxphoto"
            ...
            <label for="">库存</label>
            <input style="width: 20%;margin-left: auto;margin-right: auto;" type="text" class="form-control" id="stock" name="stock" placeholder="填入库存量">
            	请选择二级分类：
			<select name="stid">
        ...
        <button type="submit" class="btn btn-primary" onclick="beforeSubmit()">提交</button>
    </form>
